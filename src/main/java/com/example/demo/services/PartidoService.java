...
import com.example.demo.repositories.PartidoRepositorio;

@Service
public class PartidoService {

	@Autowired
	private PartidoRepositorio Prepo;
	

	
	@Transactional
	public Partido create (String torneo, String nombre1, String nombre2, Integer cant_sets, Integer p_J1, Integer p_J2) {
		...
		newPartido.setLista_Sets_J1(null);
		newPartido.setLista_Sets_J2(null);
		
		Partido response = Prepo.save(newPartido);
	...
	@Transactional
	public Partido updateSets(Integer sets_J1, Integer sets_J2, Partido partido) {
		
		partido.setSets_J1(sets_J1);
		partido.setSets_J2(sets_J2);
		
		Partido response = Prepo.save(partido);
		
		return response;
	}
		
	
	public Partido arrancarPartido(String id) {

		// Primero buscamos el partido que queremos jugar

		Partido partido = Prepo.findById(id).get();	
		...
		ArrayList<Integer> list_j1 = new ArrayList<>();
		ArrayList<Integer> list_j2 = new ArrayList<>();
